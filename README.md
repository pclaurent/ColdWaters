...
Si vous souhaitez installer les sous-marins, il est recommandé d'installer d'abord la traduction française. Par défaut, seule la "quick mission" permet leur utilisation. Le fichier Missions met à jour les missions de base pour inclure les SM français, et introduit 2 nouvelles missions en mode facile, conseillées aux débutants.
